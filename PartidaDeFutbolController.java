...
public class PartidaDeFutbolController {
    ...
    public ResponseEntity<PartidoDeFutbolModel> agregarPartido(@RequestBody @Valid PartidoDeFutbolModel obj) {
        String clubeCasa = obj.getTimeCasa();
        String clubeVisitante = obj.getTimeVisitante();

        LocalDateTime dataHoraPartida = obj.getDataHoraPartida();

        if (valiacionesService.validarPartido(obj) &&
            ...
            PartidoDeFutbolModel savedPartido = partidoDeFutbolService.save(obj);
