...
public class FutTest implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        barcelona.setPartidoDeFutbolModels(Collections.singleton(partido1));

        atleticoMadrid.setPartidoDeFutbolModels(Collections.singleton(partido2));

        Set<PartidoDeFutbolModel> realMadridSet = new HashSet<>();
        realMadridSet.add(partido1);
        realMadridSet.add(partido3);
        realMadrid.setPartidoDeFutbolModels(realMadridSet);

        Set<PartidoDeFutbolModel> sevillaSet = new HashSet<>();
        sevillaSet.add(partido2);
        sevillaSet.add(partido3);
        sevilla.setPartidoDeFutbolModels(sevillaSet);
